  ...
  return (
    <>
      <div className='itmusicfest-wrapper'>
        <div className='bg-blackeyedpeas pb-3'>
          <Container>
          ...
          <div className='blackeyedpeas-wrapper'>
            ...
            <img src='/blackeyedpeasMain.webp' alt='Black Eyed Peas' className='band' />
            <div className='info-text text-light'>
              ...
              <div className='footer-socialmedia mb-2'>
                ...
                <a href='https://www.linkedin.com/company/industrial-transformation-mexico/' target='_blank' rel='noreferrer'>
                  <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
              ...
              <p className='text-light fw-bold m-0'>ENCUÉNTRAMOS COMO</p>
              <Container>
                <p className='text-light fw-bold border-bottom pb-4'>INDUSTRIAL TRANSFORMATION MEXICO</p>
              </Container>
      ...
      {/* <div className='pt-5 register-wrapper'>
        <Container className='mb-5'>
          ...
          <div className='mt-5 d-flex justify-content-center '>
            <div className='get-register'>
              LLENA TU REGISTRO GRATUITO<br />
              <span>Y PARTICIPA PARA ASISTIR</span>
            </div>
          </div>
          <p className='text-center'>
            <span className='limit'>CUPO LIMITADO</span>
          </p>

          <p className='mt-5 text-center text-light fs-6 fw-bold m-0 lh-1'>REGISTRO ABIERTO DEL</p>
          <p className='text-center text-light fs-1 fw-bold lh-1'>20  SEPT AL 1 DE OCT</p>
          ...
          <div className='mt-5  d-flex justify-content-center '>
            <div className='get-register2'>
              SI ERES ELEGIDO RECIBIRÁS UN<br />
              <strong>MAIL DE CONFIRMACIÓN</strong>EL DÍA<br />
              3 DE OCTUBRE
            </div>
          </div>
          <Row className='mt-5'>
        ...
        <footer className='mt-5 pb-5 text-center text-light fw-bold fs-3'>
